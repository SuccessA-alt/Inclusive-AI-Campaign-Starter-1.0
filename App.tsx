            ...
            <div id="results-section" className="lg:col-span-7">
              ...
              {loadingState === LoadingState.SUCCESS && result && (
                <>
                  ...
                  {/* Download Section */}
                  <div className="mt-8 bg-white rounded-xl shadow-sm border border-slate-200 p-6 flex flex-col sm:flex-row items-center justify-between gap-4 animate-fade-in">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative">
                            <select 
                                ...
                                className="px-3 py-2 pr-8 rounded-lg border border-slate-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 bg-white text-sm outline-none appearance-none"
                            >
